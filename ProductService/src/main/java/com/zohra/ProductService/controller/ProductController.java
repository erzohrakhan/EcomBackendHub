...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<Long> addProduct(@RequestBody @Valid ProductRequest productRequest, BindingResult bindingResult) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductResponse> updateProduct(@PathVariable("id") Long productId, @RequestBody @Valid ProductRequest productRequest, BindingResult bindingResult) {
